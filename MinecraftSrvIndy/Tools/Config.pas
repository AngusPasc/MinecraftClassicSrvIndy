...
begin
  ...
  begin
    ...
    Cgf.ServerPort := StrToInt(IniFile.ReadString('Server Configuration','ServerPort', '7777'));
    Cgf.Level_Seed := StrToInt(IniFile.ReadString('Server Configuration', 'Level_Seed','476'));
    Cgf.Max_Players := StrToInt(IniFile.ReadString('Server Configuration','Max_Players', '1000'));
